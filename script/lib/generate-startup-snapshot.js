...
module.exports = function(packagedAppPath) {
  ...
  return electronLink({
    ...
    const generatedStartupBlobPath = path.join(
    ...
    if (process.platform === 'darwin') {
      ...
      startupBlobDestinationPath = path.join(
        packagedAppPath,
        'snapshot_blob.bin'
      );
    }
    ...
    console.log(
      `Moving generated startup blob into "${startupBlobDestinationPath}"`
    );
